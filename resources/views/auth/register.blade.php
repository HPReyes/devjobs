<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" novalidate>
        ...
        <div class="mt-4">
            ...
            <select name="rol" id="rol" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring-indigo-200 focus:ring-opacity-50 w-full" :value="old('rol')">
