<div class="p-10">
    <div class="mb-5">
        ...
        <div class="grid grid-cols-2 bg-gray-50 p-4 my-10">
    ...
    <div class="grid grid-cols-6 gap-4">
        <div class="col-span-2"> 
            <img class="w-1/2 mx-auto" src="{{asset('storage/vacantes/'. $vacante->imagen)}}" alt="{{'Imagen vacante' . $vacante->titulo}}">
        </div>
    ...
    <div class="mt-5 bg-gray-50 border border-dashed p-5 text-center">
        <p>
            Deseas aplicar a esta vacante? <a class="font-bold text-indigo-600" href="{{route('register')}}">Crear una cuenta</a>
        </p>
    </div>
    @endguest
